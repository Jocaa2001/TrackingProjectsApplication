...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldUsername.setText("Sinisa");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPasswordField, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE))
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        Profesor p = Controller.getInstance().login(username,password);
       
        if(p != null){
            this.dispose();
            JOptionPane.showMessageDialog(this, "Успешно сте се пријавили на систем");
            
            Controller.ulogovaniProfesor = p;
            GlavnaForma gf = new GlavnaForma(this, true);
            gf.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(this, "Систем не може да нађе професора на основу унетих вредности");
        }
